...
/* Fotos miniatura */
.img-cell { width: 60px; cursor: zoom-in; }
.table-img-mini { width: 45px; height: 45px; border-radius: 8px; object-fit: cover; border: 1px solid #E2E8F0; transition: transform 0.2s ease; }
.img-cell:hover .table-img-mini { transform: scale(1.1); }
...
.view-prod-name { font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 1.25rem; color: #1e293b; text-transform: uppercase; letter-spacing: 1px; }
.close-viewer { position: absolute; top: -15px; right: -15px; width: 40px; height: 40px; background: #ff4757; color: white; border: none; border-radius: 50%; font-size: 1.2rem; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(255, 71, 87, 0.4); transition: transform 0.2s ease; z-index: 10; }
.close-viewer:hover { transform: scale(1.1) rotate(90deg); }
